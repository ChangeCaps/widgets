    ...
    T: OrgFreedesktopNotifications + Send + 'static,
{
    cr.register("org.freedesktop.Notifications", |b| {
        ...
        b.method("Notify", ("app_name","replaces_id","app_icon","summary","body","actions","hints","expire_timeout",), ("id",), |_, t: &mut T, (app_name,replaces_id,app_icon,summary,body,actions,hints,expire_timeout,)| {
            t.notify(app_name,replaces_id,app_icon,summary,body,actions,hints,expire_timeout,)
                .map(|x| (x,))
        });
